...
[assembly: IntentTemplate("Boxfusion.Modules.Web.Startup.Swagger.ConfigureSwaggerOptions", Version = "1.0")]
...
namespace Boxfusion.Dep.Web.Host.Swagger
{
    public class ConfigureSwaggerOptions : IConfigureOptions<SwaggerGenOptions>
    {
        ...
        private OpenApiInfo CreateInfoForApiVersion(ApiVersionDescription description)
        {
            ...
            {
                Title = string.Format(_openApiInfo.Title ?? "Dep Api", description.ApiVersion.ToString()),
